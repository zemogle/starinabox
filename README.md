...
You can find all of our educational resources to accompany Star in a Box on the [astroEDU website](https://lco.global/education/activities/star-in-a-box/).

Translations
----

Star in a Box can handle multiple languages. The simplest way to translate this app is:
* Fill out the translation forms [normal](https://starinabox.net/translate.html) and [advanced](https:///starinabox.net/translate_advanced.html),
...
[Edward Gomez](https://www.zemogle.net) is the maintainer of Star in a Box